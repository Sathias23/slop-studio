...
Workflow templates live in `templates/` as `.json` + `.meta.json` pairs. Twenty-three starter templates ship with every project, spanning both backends:
